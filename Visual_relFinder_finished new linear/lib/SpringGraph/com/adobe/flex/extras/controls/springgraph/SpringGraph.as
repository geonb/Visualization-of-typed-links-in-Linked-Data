 ...
 */	
 public class SpringGraph extends Canvas {
		...
		private function drawEdges(): void {
			...
			u.graphics.lineStyle(3,0xdddddd,1);
			u.graphics.beginFill(0xdddddd,1);
			u.graphics.moveTo(360, 0);
			u.graphics.lineTo(360, 12000);
			u.graphics.endFill();
			
			u.graphics.lineStyle(3,0xdddddd,1);
			u.graphics.beginFill(0xdddddd, 1);
			u.graphics.moveTo(200, 0);
			u.graphics.lineTo(200, 12000);
			u.graphics.endFill();
			
			u.graphics.lineStyle(3,0xbbbbbb,1);
			u.graphics.beginFill(0xbbbbbb, 1);
			u.graphics.moveTo(560, 0);
			u.graphics.lineTo(560, 12000);
			u.graphics.endFill();
			
			u.graphics.lineStyle(3,0xbbbbbb,1);
			u.graphics.beginFill(0xbbbbbb, 1);
			u.graphics.moveTo(720, 0);
			u.graphics.lineTo(720, 12000);
			u.graphics.endFill();
			
			u.graphics.lineStyle(3,0xbbbbbb,1);
			u.graphics.beginFill(0xbbbbbb, 1);
			u.graphics.moveTo(940, 0);
			u.graphics.lineTo(940, 12000);
			u.graphics.endFill();
			
			drawingSurface.addChild(u);
		...
		private function drawEdge(f: UIComponent, t: UIComponent, color: int): void {
			var fromX: int = f.x + (f.width - 86);
			var fromY: int = f.y + 10;
			var toX: int = t.x + (t.width - 86);
			var toY: int = t.y + 10;
	    ...
	    /** @private */
   		...
   		private function dragContinue(event: MouseEvent):void  {
   			...
   			if(dragComponent == null || dragComponent.height > 30) return;
